...
// "EXTERNAL" is unused while only the synthetic provider is wired up (see
// IMarketDataProvider) — kept in the schema/type as the reserved,
// provider-agnostic value a future real provider would write.
